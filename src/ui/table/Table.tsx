...
// export default function Table() {
//     const [addFieldModalIsOpen, setAddFieldModalIsOpen] = useState(false)
...
//                         <th className="border-b">
//                             <button
//                                 // onClick={() => setAddFieldModalIsOpen(true)}
//                                 onClick={() => setAddFieldModalIsOpen(true)}
//                                 className="text-2xl font-bold w-full h-full focus:ring-1 focus:ring-stone-700"
//                             >
//                                 +
...
//             <AddNewFieldModal isOpen={addFieldModalIsOpen} onClose={() => setAddFieldModalIsOpen(false)} />
